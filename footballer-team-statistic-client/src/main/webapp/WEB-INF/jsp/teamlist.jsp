            ...
            <div class="modal-content">
                ...
                <form method="POST" action="/teams/add">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="stadiumname" class="col-form-label">Stadium name:</label>
                            <input type="text" name="stadiumname" class="form-control" id="stadiumname">
                        </div>
                        <div class="form-group">
                            <label for="seasonscount" class="col-form-label">Count of seasons:</label>
                            <input type="number" name="seasonscount" class="form-control" id="seasonscount">
                        </div>
                    </div>
